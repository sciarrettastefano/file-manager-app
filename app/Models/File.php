...
class File extends Model
{
    ...
    {   // Restituisce proprietario in modod leggibile affinchè l'utente lo visualizzi
    ...
    {   // Controlla prooprietà di un file da parte di un utente
    ...
    protected static function boot()
    {
        ...
        {   // creating: prima che un record venga creato, per calcolarne il path
            if (!$model->parent){
                return;
            }
